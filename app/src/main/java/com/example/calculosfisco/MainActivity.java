package com.example.calculosfisco;
...
/*
    class btRBT12Clicked implements Button.OnClickListener{
        ...
        public void onClick(View v) {
            Toast.makeText(MainActivity.this, "AEW2", Toast.LENGTH_SHORT).show();
            Intent myIntent = new Intent(MainActivity.this, RbtActivity.class);
